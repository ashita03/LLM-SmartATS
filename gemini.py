...
Task:
Imagine yourself as an expert ATS resume viewer, and go through all of the Resume bullet points to ensure it matches with the key skills and words in the Job Description. You have to revamp the work experience such that most skills requirements and the most important keywords mentioned in the Job Description are ALL present in the Resume and additionally being highlighted. The main aim is to ensure that the applicant stands out as a Top Applicant for the respective Job Description. (The Resume Match with the Job Description must be '92%' or above at minimum). In order to achieve this, do not force it. Maintain a good balance. Based on the theme of the job description or the main project, align project points to that. Make sure to use all the keywords and skills at least once.
If for instance the work experience is completely different from what is requested in the Job Description then suggest all the necessary changes that would be needed to match the resume to the Job Description. Additionally, provide suggestions whenever the resume bullet points are not relevant by tweaking the existing bullet points
